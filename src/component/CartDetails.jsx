...
const CartDetails = () => {
  ...
  const makePayment = async () => {
    const stripe = await loadStripe(
      "pk_test_51OdtNOSJGQzVMklLwTM8gKSg0S5aDA7DCCy50hGP7yPfkIEaVHP7eGBr4BgVvxMFkn7KquOntXMfl45ahseRVKFe00GX8Xjgr7"
    );
              ...
              <table className="table cart-table mb-0 table-responsive-sm">
                <thead>
                  <tr>
                    ...
                    <th className="text-right">
                      {" "}
                      <span id="amount" className="amout">
                        Total Amount
                      </span>
                    </th>
                  </tr>
                        ...
                        <tr>
                          ...
                          <td>
                            <div className="product-img">
                              <img src={data.imgdata} alt="" srcset="" />
                            </div>
                          </td>
                          <td>
                ...
                <tfoot>
                  <tr>
                    ...
                    <th colSpan={2}>&nbsp;</th>
                    <th>
                      Items in Cart <span className="m1-2 mr-2">:</span>
                      <span className="text-danger">{totalQuantity}</span>
                    </th>
                    <th className="text-right">
                      Total Price <span className="m1-2 mr-2">:</span>
